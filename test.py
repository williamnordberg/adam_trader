...
from handy_modules import get_bitcoin_price, read_float_from_latest_saved, read_current_trading_state
...
app.layout = html.Div([
    dcc.Interval(
        ...
        interval=1 * 1000,  # in milliseconds (every 1 seconds)
        n_intervals=0
    ),
...
# Create a new callback that listens to the dcc.Interval component and updates the dcc.Graph component.
@app.callback(
