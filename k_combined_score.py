...
def make_trading_decision(factor_values) -> Tuple[float, float]:
    factors = (
        (factor_values['macro_bullish'], factor_values['macro_bearish']),
        (factor_values['order_book_bullish'], factor_values['order_book_bearish']),
        (factor_values['prediction_bullish'], factor_values['prediction_bearish']),
        (factor_values['technical_bullish'], factor_values['technical_bearish']),
        (factor_values['richest_bullish'], factor_values['richest_bearish']),
        (factor_values['google_bullish'], factor_values['google_bearish']),
        (factor_values['reddit_bullish'], factor_values['reddit_bearish']),
        (factor_values['youtube_bullish'], factor_values['youtube_bearish']),
        (factor_values['news_bullish'], factor_values['news_bearish'])
    )
    ...
    for factor, (bullish, bearish) in zip(WEIGHTS.values(), factors):
        ...
        weighted_score_down += factor * bearish
