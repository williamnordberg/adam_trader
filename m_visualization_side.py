...
from z_handy_modules import get_bitcoin_price, retry_on_error, COLORS, update_intervals
...
def read_layout_data():
    ...
    layout_data = {
        ...
        "rsi": read_latest_data("latest_rsi", float),
        "over_200EMA": read_latest_data("over_200EMA", float),
        "MACD_uptrend": database['technical_potential_up_trend'][-1],
        "bb_MA_distance": read_latest_data("bb_band_MA_distance", float),
        "BTC_received": read_latest_data("total_received_coins_in_last_24", int),
        "BTC_send": read_latest_data("total_sent_coins_in_last_24", bool),
        "positive_news_polarity_change": round(read_latest_data("positive_news_polarity_change", float), 0),
        "negative_news_polarity_change": round(read_latest_data("negative_news_polarity_change", float), 0),
