...
def create_widget():
    html_div_list = [
        ...
        html.Div(children=[
            html.Iframe(src='/assets/stock_heatmap.html', style={'width': '90%', 'height': '300px'}),
        ],
